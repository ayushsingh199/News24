const API_KEY = "103814faafd6453ab2bfd2ed8ff2371c";
...
function analyzeSentiment(text) {
    ...
    const positiveWords = new Set([
        'good', 'great', 'awesome', 'excellent', 'happy', 'positive', 'success', 
        'breakthrough', 'win', 'winning', 'progress', 'achieve', 'achievement',
        'improve', 'improvement', 'benefit', 'innovative', 'innovation'
    ]);

    const negativeWords = new Set([
        'bad', 'terrible', 'awful', 'poor', 'negative', 'fail', 'failure',
        'crisis', 'problem', 'disaster', 'conflict', 'decline', 'crash',
        'risk', 'threat', 'warning', 'danger', 'dangerous'
    ]);
...
function fillDataInCard(cardClone, article) {
    ...
    sentimentIcon.className = `sentiment-icon ${getSentimentIcon(sentiment)} sentiment-${sentiment}`;
